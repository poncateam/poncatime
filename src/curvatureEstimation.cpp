...
// helper class required to retrieve the number of neighbors used during the Fit
template < class DataPoint, class _WFunctor, typename T = void  >
struct NumNeighborHelper : public T
{
    int getNumNeighbors() { return T::m_nbNeighbors; }
};

using NF        = DistWeightFunc<MyPointSimple, SmoothWeightKernel<double> > ;
using ASOFit    = Basket<MyPointSimple, NF, OrientedSphereFit, OrientedSphereSpaceDer, MlsSphereFitDer, NumNeighborHelper>;
using PlaneFit  = Basket<MyPointSimple, NF, CovariancePlaneFit, NumNeighborHelper>;
